...
if __name__ == '__main__':
    conf = SparkConf().setAppName('collaborativeFiltering').setMaster('local').set( "spark.driver.host", "localhost" )
    spark = SparkSession.builder.config(conf=conf).getOrCreate()
    
    file_path = '../PocketRocket'
    ratingResourcesPath = file_path + '/webroot/server/sql/ratings.csv'
