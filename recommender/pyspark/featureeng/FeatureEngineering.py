...
import os
# os.environ['JAVA_HOME'] = "/usr/local/Cellar/openjdk@8/1.8.0+282/libexec/openjdk.jdk/Contents/Home"
...
def oneHotEncoderExample(movieSamples):
    ...
    # (1001,[1],[1.0]) represents 1001 dimensions with 1.0 at the 1st dimension
