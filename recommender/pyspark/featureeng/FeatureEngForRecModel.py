...
def addMovieFeatures(movieSamples, ratingSamplesWithLabel):
    ...
    samplesWithMovies2 = ratingSamplesWithLabel.join(movieSamples, on=['movieId'], how='left')
...
if __name__ == '__main__':
    conf = SparkConf().setAppName('featureEngineering').setMaster('local').set( "spark.driver.host", "localhost" )
    spark = SparkSession.builder.config(conf=conf).getOrCreate()
    file_path = '../PocketRocket'
    movieResourcesPath = file_path + "/webroot/server/sql/movies.csv"
    ratingsResourcesPath = file_path + "/webroot/server/sql/ratings.csv"
    ...
    splitAndSaveTrainingTestSamples(samplesWithUserFeatures, file_path + "/webroot/sampledata_pyspark")
    # splitAndSaveTrainingTestSamplesByTimeStamp(samplesWithUserFeatures, file_path + "/webroot/sampledata_pyspark")

#{"movieId":1,"userId":15555,"rating":3,"timestamp":900953740,"label":0,"releaseYear":1995,"movieGenre1":'Adventure',"movieGenre2":'Animation',"movieGenre3":'Children',"movieRatingCount":10759,"movieAvgRating":3.91,"movieRatingStddev":0.89,"userRatedMovie1":783,"userRatedMovie2":434,"userRatedMovie3":208,"userRatedMovie4": 349,"userRatedMovie5":112,"userRatingCount":92,"userAvgReleaseYear":1992,"userReleaseYearStddev":8.98,"userAvgRating":3.86,"userRatingStddev":0.74,"userGenre1": 'Drama',"userGenre2":'Comedy',"userGenre3":'Thriller',"userGenre4":'Action',"userGenre5": 'Crime'}